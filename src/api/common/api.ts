...
enum Api {
  ...
  positionList = '/sys/position/list.json',
  userList = '/sys/user/list.json',
  roleList = '/sys/role/list.json',
  queryDepartTreeSync = '/sys/sysDepart/queryDepartTreeSync.json',
  queryTreeList = '/sys/sysDepart/queryTreeList.json',
  loadTreeData = '/sys/category/loadTreeData.json',
  loadDictItem = '/sys/category/loadDictItem/.json',
  getDictItems = '/sys/dict/getDictItems/.json',
  getTableList = '/sys/user/queryUserComponentData.json',
  getCategoryData = '/sys/category/loadAllData.json',
}
...
export const uploadUrl = `${baseUploadUrl}/sys/common/upload.json`;
