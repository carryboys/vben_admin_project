<template>
  ...
  <div>
    ...
    >
      <div class="hexagon-basic-table-form-container" v-if="showSearchFlag">
        <a-form
          ref="formRef"
          :model="queryParam"
          :label-col="labelCol"
...
<script lang="ts">
  ...
  import { usePopBiz } from '/@/components/hexagon/OnLine/hooks/usePopBiz';
  ...
  export default defineComponent({
    ...
    components: {
      ...
      SearchFormItem: createAsyncComponent(
        () => import('/@/components/hexagon/OnLine/SearchFormItem.vue'),
        { loading: false },
      ),
...
<style lang="less" scoped>
  ...
  :deep .hexagon-basic-table .ant-table-wrapper .ant-table-title {
    min-height: 0;
  }
</style>
