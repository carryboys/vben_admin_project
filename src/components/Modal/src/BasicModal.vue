<template>
  <Modal v-bind="getBindValue" @cancel="handleCancel">
    ...
    <a-row class="hexagon-modal-wrapper">
      <a-col :span="24 - commentSpan" class="hexagon-modal-content">
        <ModalWrapper
      ...
      <a-col :span="commentSpan" class="hexagon-comment-outer">
