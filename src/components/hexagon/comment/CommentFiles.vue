<template>
  <div>
    <a-alert type="info" class="hexagon-comment-files">
      <template #message>
        <span class="j-icon">
          <a-upload
            multiple
    ...
    <div class="selected-file-warp" v-if="selectFileList && selectFileList.length > 0">
      ...
      <div style="margin-bottom: 24px; margin-top: 18px; text-align: right">
        ...
        <a-button type="primary" style="margin-left: 10px" @click="queding" :loading="buttonLoading"
          >确定</a-button
        >
      </div>
    </div>
...
<script>
  ...
  import JUpload from '/@/components/Form/src/hexagon/components/JUpload/JUpload.vue';
