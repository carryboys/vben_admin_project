...
enum Api {
  ...
  list = '/sys/dataSource/list.json',
  save = '/sys/dataSource/add.json',
  edit = '/sys/dataSource/edit.json',
  get = '/sys/dataSource/queryById.json',
  delete = '/sys/dataSource/delete.json',
  testConnection = '/sys/dataSource/testConnection.json',
  deleteBatch = '/sys/dataSource/deleteBatch.json',
  exportXlsUrl = 'sys/dataSource/exportXls.json',
  importExcelUrl = 'sys/dataSource/importExcel.json',
}
/**
 * 导出api
 */
