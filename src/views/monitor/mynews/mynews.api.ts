...
enum Api {
  ...
  list = '/sys/sysAnnouncementSend/getMyAnnouncementSend.json',
  editCementSend = '/sys/sysAnnouncementSend/editByAnntIdAndUserId.json',
  readAllMsg = '/sys/sysAnnouncementSend/readAll.json',
  syncNotic = '/sys/annountCement/syncNotic.json',
  getOne = '/sys/sysAnnouncementSend/getOne.json',
}
...
export const editCementSend = (params) => {
  ...
  return defHttp.post({ url: Api.editCementSend, params });
};
    ...
    onOk: () => {
      return (
        defHttp
          ...
          .post({ url: Api.readAllMsg, data: params }, { joinParamsToUrl: true })
          .then(() => {
            handleSuccess();
          })
      );
