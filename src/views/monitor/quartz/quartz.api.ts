...
enum Api {
  ...
  list = '/sys/quartzJob/list.json',
  save = '/sys/quartzJob/add.json',
  edit = '/sys/quartzJob/edit.json',
  get = '/sys/quartzJob/queryById.json',
  pause = '/sys/quartzJob/pause.json',
  resume = '/sys/quartzJob/resume.json',
  delete = '/sys/quartzJob/delete.json',
  exportXlsUrl = '/sys/quartzJob/exportXls.json',
  importExcelUrl = '/sys/quartzJob/importExcel.json',
  execute = '/sys/quartzJob/execute.json',
  deleteBatch = '/sys/quartzJob/deleteBatch.json',
}
