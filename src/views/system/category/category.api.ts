...
enum Api {
  ...
  list = '/sys/category/rootList.json',
  save = '/sys/category/add.json',
  edit = '/sys/category/edit.json',
  deleteCategory = '/sys/category/delete.json',
  deleteBatch = '/sys/category/deleteBatch.json',
  importExcel = '/sys/category/importExcel.json',
  exportXls = '/sys/category/exportXls.json',
  loadTreeData = '/sys/category/loadTreeRoot.json',
  getChildList = '/sys/category/childList.json',
  getChildListBatch = '/sys/category/getChildListBatch.json',
}
/**
 * 导出api
 * @param params
