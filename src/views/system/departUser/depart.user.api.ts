...
enum Api {
  ...
  treeList = '/sys/sysDepart/queryMyDeptTreeList.json',
  queryIdTree = '/sys/sysDepart/queryIdTree.json',
  searchBy = '/sys/sysDepart/searchBy.json',
}
...
enum DepartUserApi {
  ...
  list = '/sys/user/departUserList.json',
  link = '/sys/user/editSysDepartWithUser.json',
  unlink = '/sys/user/deleteUserInDepartBatch.json',
}
...
enum DepartRoleApi {
  ...
  list = '/sys/sysDepartRole/list.json',
  deleteBatch = '/sys/sysDepartRole/deleteBatch.json',
  save = '/sys/sysDepartRole/add.json',
  edit = '/sys/sysDepartRole/edit.json',
  queryTreeListForDeptRole = '/sys/sysDepartPermission/queryTreeListForDeptRole.json',
  queryDeptRolePermission = '/sys/sysDepartPermission/queryDeptRolePermission.json',
  saveDeptRolePermission = '/sys/sysDepartPermission/saveDeptRolePermission.json',
  dataRule = '/sys/sysDepartRole/datarule.json',
  getDeptRoleList = '/sys/sysDepartRole/getDeptRoleList.json',
  getDeptRoleByUserId = '/sys/sysDepartRole/getDeptRoleByUserId.json',
  saveDeptRoleUser = '/sys/sysDepartRole/deptRoleUserAdd.json',
}
...
export const saveOrUpdateDepartRole = (params, isUpdate) => {
  if (isUpdate) {
    ...
    return defHttp.post({ url: DepartRoleApi.edit, params });
  } else {
