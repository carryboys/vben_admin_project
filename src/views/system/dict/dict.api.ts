...
enum Api {
  ...
  list = '/sys/dict/list.json',
  save = '/sys/dict/add.json',
  edit = '/sys/dict/edit.json',
  duplicateCheck = '/sys/duplicate/check.json',
  deleteDict = '/sys/dict/delete.json',
  deleteBatch = '/sys/dict/deleteBatch.json',
  importExcel = '/sys/dict/importExcel.json',
  exportXls = '/sys/dict/exportXls.json',
  recycleBinList = '/sys/dict/deleteList.json',
  putRecycleBin = '/sys/dict/back.json',
  deleteRecycleBin = '/sys/dict/deletePhysic.json',
  itemList = '/sys/dictItem/list.json',
  deleteItem = '/sys/dictItem/delete.json',
  itemSave = '/sys/dictItem/add.json',
  itemEdit = '/sys/dictItem/edit.json',
  dictItemCheck = '/sys/dictItem/dictItemCheck.json',
  refreshCache = '/sys/dict/refleshCache.json',
  queryAllDictItems = '/sys/dict/queryAllDictItems.json',
}
/**
 * 导出api
 * @param params
...
export const deleteRecycleBin = (id, handleSuccess) => {
  ...
  return defHttp.get({ url: Api.deleteRecycleBin }).then(() => {
    handleSuccess();
  });
};
/**
