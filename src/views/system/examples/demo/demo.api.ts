...
enum Api {
  list = '/test/hexagonDemo/list',
  save = '/test/hexagonDemo/add',
  edit = '/test/hexagonDemo/edit',
  get = '/test/hexagonDemo/queryById',
  delete = '/test/hexagonDemo/delete',
  deleteBatch = '/test/hexagonDemo/deleteBatch',
  exportXls = '/test/hexagonDemo/exportXls',
  importExcel = '/test/hexagonDemo/importExcel',
}
/**
 * 导出api
 */
