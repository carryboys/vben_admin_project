<template>
  <div>
    <!--自定义查询区域-->
    <div class="hexagon-basic-table-form-container" @keyup.enter="searchQuery" v-if="customSearch">
...
<script lang="ts" setup>
  ...
  import JImportModal from '/@/components/Form/src/hexagon/components/JImportModal.vue';
  import JDictSelectTag from '/@/components/Form/src/hexagon/components/JDictSelectTag.vue';
...
<style lang="less" scoped>
  .hexagon-basic-table-form-container {
