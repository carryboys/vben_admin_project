...
export enum Api {
  ...
  list = '/sys/message/sysMessage/list.json',
  delete = '/sys/message/sysMessage/delete.json',
  deleteBatch = '/sys/message/sysMessage/deleteBatch.json',
  exportXls = 'sys/message/sysMessage/exportXls.json',
  importXls = 'sys/message/sysMessage/importExcel.json',
  save = '/sys/message/sysMessage/add.json',
  edit = '/sys/message/sysMessage/edit.json',
}
