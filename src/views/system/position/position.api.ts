...
enum Api {
  ...
  list = '/sys/position/list.json',
  save = '/sys/position/add.json',
  edit = '/sys/position/edit.json',
  get = '/sys/position/queryById.json',
  delete = '/sys/position/delete.json',
  importExcel = '/sys/position/importExcel.json',
  exportXls = '/sys/position/exportXls.json',
  deleteBatch = '/sys/position/deleteBatch.json',
}
/**
 * 导出api
 */
